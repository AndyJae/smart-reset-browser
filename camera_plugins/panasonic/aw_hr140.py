"""
camera_plugins/panasonic/aw_hr140.py — Panasonic AW-HR140

Outdoor weatherproof HD PTZ camera with integrated housing controls
(defroster, wiper, heater, fan, washer pump).
...
# ---------------------------------------------------------------------------
# RESET_COMMANDS  (image quality only — housing state is not reset)
# ---------------------------------------------------------------------------
...
RESET_COMMANDS = [
    ...
    ("ATW SPEED",                        "OSI", "25", "0"),
    ("ATW WIDTH",                        "OSI", "26", "0"),    # ATW range width
    # Gamma
